...
public class PermissionController {
     ...
     */
    @PostMapping
    public ApiResult<Integer> create(@RequestBody Permission permission) {
     ...
     */
    @PutMapping
    public ApiResult<Integer> update(@RequestBody Permission permission) {
     ...
     */
    @GetMapping("/{id}")
    public ApiResult<Permission> getById(@PathVariable Long id) {
